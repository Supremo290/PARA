    ...
    >
      <style>{`
        ...
        .corner-glow-tr {
          ...
          background: radial-gradient(ellipse at top right, rgba(139,92,246,0.2) 0%, transparent 65%);
        }
        .corner-glow-bl {
          position: absolute; pointer-events: none;
          bottom: 0; left: 0; width: 500px; height: 360px;
          background: radial-gradient(ellipse at bottom left, rgba(29,78,216,0.16) 0%, transparent 65%);
        }
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        {/* SVG: light beams + floating particles */}
        <svg
        ...
        <div
          ...
          style={{ background: 'radial-gradient(ellipse 52% 75% at 0% 50%, rgba(4,9,30,0.88) 0%, transparent 52%)' }}
        />
          ...
          >
            ...
            >
              ...
              <span
                className="block"
                style={{
                  background: 'linear-gradient(90deg, #a78bfa 0%, #6366f1 45%, #3b82f6 100%)',
